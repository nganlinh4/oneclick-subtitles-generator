...
fn validate_release(
    ...
    for file in &release.files {
        ...
        has_aligner |= file.role == FileRole::Aligner
            && release
    ...
    if total != release.unpacked_size_bytes
        ...
        || !has_model
        || !python_matches
        || engine.requires_aligner() != has_aligner
    {
        return Err(PackageError::InvalidCatalog);
    }
...
mod tests {
    ...
    #[test]
    fn checked_in_catalog_explicitly_withholds_unpublished_deliveries() {
