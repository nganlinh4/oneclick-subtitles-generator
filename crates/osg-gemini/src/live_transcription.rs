...
// Prerecorded media is packet-paced at 2x without time-stretching or resampling its samples. A
// cross-language/noise/two-speaker provider benchmark produced byte-identical finals at 1x and 2x;
// the source clock remains derived from PCM bytes, never wall time.
